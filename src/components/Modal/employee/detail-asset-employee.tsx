...
const DetailEmployee = ({deskripsi, kategori}: detailEmployeeProps) => {
    return(
        <>
            ...
            <Box>
                <FormLabel style={{ fontWeight: "bold" }}>Deskripsi Aset</FormLabel>
                 <Box>
                     <FormLabel ms={5} style={{ fontWeight: "bold" }}>{deskripsi}</FormLabel>
                 </Box>
            </Box>
            <Box>
                <FormLabel style={{ fontWeight: "bold" }}>Kategori Aset</FormLabel>
                 <Box>
                     <FormLabel ms={5} style={{ fontWeight: "bold" }}>{kategori}</FormLabel>
                 </Box>
            </Box>
